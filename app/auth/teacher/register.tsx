    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      >
        ...
        >
          ...
          <Text className="text-gray-500 text-sm mb-6">Set up your teacher account below</Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push('/auth/choose-login-account')}
          >
          ...
          <View className="flex-row justify-center items-center">
            ...
            <TouchableOpacity onPress={() => router.push("/auth/choose-login-account")}>
